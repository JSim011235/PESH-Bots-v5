...
public class RedFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence right = drive.trajectorySequenceBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-36,-44,Math.toRadians(-220)))
        ...
        TrajectorySequence left = drive.trajectorySequenceBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-46,-40,Math.toRadians(-60)))
                .addDisplacementMarker(() -> {
                    robot.autoDrop.setPosition(0.6);
                })
                .waitSeconds(.5)
        ...
        TrajectorySequence center = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(0.01)
                .lineToLinearHeading(new Pose2d(45,-17,Math.toRadians(180)))
                .waitSeconds(0.01)
        ...
        TrajectorySequence park1 = drive.trajectorySequenceBuilder(cyclePoseStart)
                .lineToLinearHeading(new Pose2d(57,-17.5,Math.toRadians(180)))
                .lineToLinearHeading(new Pose2d(66,-17.5,Math.toRadians(180)))
                .build();
